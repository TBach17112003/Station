...
#         self.Cloud_COM = Cloud_COM.__init__()
...
#         if self.all_data_window is None or not self.all_data_window.winfo_exists():
#             self.all_data_window = all_data.AllData_ChartWindow(self.root)
#             # # Bind the destroy event for the all data window
#             # self.all_data_window.protocol("WM_DELETE_WINDOW", self.on_all_data_window_close)
...
#     def on_close(self):
#         # Ensure the chart window and all data window are destroyed when the main window is closed
#         if self.chart_window and self.chart_window.data_window.winfo_exists():
#             self.chart_window.data_window.destroy()
#         if self.all_data_window and self.all_data_window.winfo_exists():
#             self.all_data_window.destroy()
#         self.root.destroy()
import customtkinter as ctk
import re
